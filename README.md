...
│   ├── Relay de Correo/                   # Configuración del Relay SMTP local (10.55.40.10:2525)
...
* **Servidor:** `Rasp_Node_1` (`10.55.40.10:4000`)
...
* **Servidor:** `Rasp_Node_1` (`10.55.40.10:2525`)
